                        ...
                        <div class="card-body">
                            ...
                            <form action="/enroll" method="post" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-field" name="session-number"
                                        placeholder="Session #">
                                    <input type="text" class="form-control -field" name="assignment-title"
                                        placeholder="Assignment Title">
                                    <input type="date" class="form-control input-field" name="date">
                                    <div class="time-range">
                                        <input type="time" class="form-control -field" name="start-time">
                                        <span>To</span>
                                        <input type="time" class="form-control input-field" name="end-time">
                                    </div>
                                    <select class="form-control input-field" name="submission-type">
