...
<body>
                    ...
                    <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                <form action="/student_profile" method="post" id="studentNameForm"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mx-auto">
                                                @if ($student && $student['name'])
                                                    <center>
                                                        <h5 id="noUsername">{{ $student['name'] }}</h5>
                                                    </center>
                                                @else
                                                    <center>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" style="background-color: #d95c5c">
                                <div class="container-md">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="text-white">Student's Information</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4 form-group">
                                            ...
                                            @if ($student && $student['address'])
                                                <textarea required name="address" id="" cols="30" rows="5" class="form-control">{{ $student['address'] }}</textarea>
                                            @else
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            @if ($student && $student['contactNumber'])
                                                <input required type="number" name="contactNumber" id=""
                                                    class="form-control" value="{{ $student['contactNumber'] }}">
                                            @else
                                                <input required type="number" name="contactNumber" id=""
                                                    class="form-control">
                                            @endif
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label for="email" class="text-dark"><b>Guardian Email:</b><span
                                                    class="text-danger">*</span> </label>

                                            @if ($student && $student['guardianEmail'])
                                                <input required type="email" name="email" id=""
                                                    class="form-control" value="{{ $student['guardianEmail'] }}">
                                            @else
                                                <input required type="email" name="email" id=""
                                                    class="form-control">
                                            @endif
    ...
    <script>
        ...
        function clearMe() {
            let studentNameForm = document.getElementById('studentNameForm');
            studentNameForm.setAttribute("onsubmit", "return false;");
            let noUsername = document.getElementById('noUsername');
            let teacherName = document.getElementById('teacherName');
            let btnClear = document.getElementById('btnClear');
